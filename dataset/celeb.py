...
class CelebDataset(Dataset):
    def __init__(self, mode: str = 'train', env: str = 'local'):
        ...
        train_val_split = pd.read_csv(f'{self._file_location}celebA_train_split.txt', sep=' ', names=['Image', 'Mode'])
        image_annos = pd.read_csv(f'{self._file_location}celebA_anno.txt', sep=' ', names=['Image', 'Target'])
        train_split_class_annotations, val_split_class_annotations, test_split_class_annotations = self.prepare_data(train_val_split, image_annos)
    ...
    def prepare_data(self, train_val_split: pd.DataFrame, class_annotations: pd.DataFrame):
      ...
      train_split_class_annotations = train_split_class_annotations[train_split_class_annotations['Target'].isin(valid_classes)]
      val_split_class_annotations = val_split_class_annotations[val_split_class_annotations['Target'].isin(valid_classes)]
      test_split_class_annotations = test_split_class_annotations[test_split_class_annotations['Target'].isin(valid_classes)]
